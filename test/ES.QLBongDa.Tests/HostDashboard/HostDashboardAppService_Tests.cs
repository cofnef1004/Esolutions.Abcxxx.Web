...
using ES.QLBongDa.MultiTenancy.HostDashboard;
...
namespace ES.QLBongDa.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(QLBongDaDbContext context, SubscriptionPayment subscriptionPayment)
        {
