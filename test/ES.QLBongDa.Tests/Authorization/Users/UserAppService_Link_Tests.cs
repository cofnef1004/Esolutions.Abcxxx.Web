...
namespace ES.QLBongDa.Tests.Authorization.Users
{
    ...
    public class UserAppService_Link_Tests : UserAppServiceTestBase
    {
        ...
        private async Task<int> CreateTestTenantAndTestUser()
        {
            ...
            {
                ConnectionString = SimpleStringCipher.Instance.Encrypt("Server=localhost; Database=QLBongDaTest_" + Guid.NewGuid().ToString("N") + "; Trusted_Connection=True;")
            };
