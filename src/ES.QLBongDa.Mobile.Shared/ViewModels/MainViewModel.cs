...
using ES.QLBongDa.ApiClient;
using ES.QLBongDa.Controls;
using ES.QLBongDa.Dto;
using ES.QLBongDa.Extensions;
using ES.QLBongDa.Localization;
using ES.QLBongDa.UI;
using ES.QLBongDa.UI.Assets;
using ES.QLBongDa.Views;
using DependencyResolver = ES.QLBongDa.Core.Dependency.DependencyResolver;
...
namespace ES.QLBongDa.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "QLBongDa";
