...
using ES.QLBongDa.Authorization.Users.Password;
using ES.QLBongDa.Configuration;
using ES.QLBongDa.EntityFrameworkCore;
using ES.QLBongDa.MultiTenancy;
using ES.QLBongDa.Web.Startup.ExternalLoginInfoProviders;
...
namespace ES.QLBongDa.Web.Startup
{
    ...
    public class QLBongDaWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public QLBongDaWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(QLBongDaWebHostModule).GetAssembly());
        }
