...
using ES.QLBongDa.DynamicEntityPropertyValues.Dto;

namespace ES.QLBongDa.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : QLBongDaAppServiceBase, IDynamicEntityPropertyValueAppService
    {
