...
using ES.QLBongDa.Migrations.Seed.Host;
...
namespace ES.QLBongDa.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : QLBongDaAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<QLBongDaDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{QLBongDaConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{QLBongDaConsts.ConnectionStringName}", constring);
        }
