...
{
    [AbpAuthorize(AppPermissions.Pages_QLBongDaUiComponents)]
    public class QLBongDaUiComponentsAppService : QLBongDaAppServiceBase, IQLBongDaUiComponentsAppService
    {
