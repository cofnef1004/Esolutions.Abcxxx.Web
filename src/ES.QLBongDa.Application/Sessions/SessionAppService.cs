...
{
    public class SessionAppService : QLBongDaAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = QLBongDaConsts.Currency,
                        CurrencySign = QLBongDaConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = QLBongDaConsts.AllowTenantsToChangeEmailSettings,
