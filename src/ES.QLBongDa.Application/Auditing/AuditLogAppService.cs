...
using ES.QLBongDa.Auditing.Exporting;
using ES.QLBongDa.Authorization;
using ES.QLBongDa.Authorization.Users;
using ES.QLBongDa.Dto;
using ES.QLBongDa.EntityHistory;
using EntityHistoryHelper = ES.QLBongDa.EntityHistory.EntityHistoryHelper;

namespace ES.QLBongDa.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : QLBongDaAppServiceBase, IAuditLogAppService
    {
