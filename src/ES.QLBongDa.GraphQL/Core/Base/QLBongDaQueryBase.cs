...
namespace ES.QLBongDa.Core.Base
{
    public abstract class QLBongDaQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected QLBongDaQueryBase(string fieldName,
