...
using ES.QLBongDa.Core.Base;
using ES.QLBongDa.Core.Extensions;
using ES.QLBongDa.Dto;
using ES.QLBongDa.Types;

namespace ES.QLBongDa.Queries
{
    public class OrganizationUnitQuery : QLBongDaQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
