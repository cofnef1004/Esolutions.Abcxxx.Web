...
{
    public class SubscriptionPaymentExtensionDataRepository : QLBongDaRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<QLBongDaDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
