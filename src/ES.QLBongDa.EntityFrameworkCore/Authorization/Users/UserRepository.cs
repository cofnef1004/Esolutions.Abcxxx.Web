...
{
    public class UserRepository : QLBongDaRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<QLBongDaDbContext> dbContextProvider)
