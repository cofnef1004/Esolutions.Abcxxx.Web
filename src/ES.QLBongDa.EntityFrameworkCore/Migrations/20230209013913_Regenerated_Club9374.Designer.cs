...
namespace ES.QLBongDa.Migrations
{
    ...
    [Migration("20230209013913_Regenerated_Club9374")]
    partial class Regenerated_Club9374
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ES.QLBongDa.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ES.QLBongDa.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ES.QLBongDa.Clubs.Club", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ES.QLBongDa.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ES.QLBongDa.Stadiums.Stadium", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ES.QLBongDa.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ES.QLBongDa.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ES.QLBongDa.Clubs.Club", b =>
                {
                    b.HasOne("ES.QLBongDa.Stadiums.Stadium", "StadiumFk")
                        .WithMany()
