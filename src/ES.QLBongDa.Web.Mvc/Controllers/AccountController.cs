...
using ES.QLBongDa.Net.Sms;
using ES.QLBongDa.Notifications;
using ES.QLBongDa.Web.Models.Account;
using ES.QLBongDa.Security;
using ES.QLBongDa.Security.Recaptcha;
using ES.QLBongDa.Sessions;
using ES.QLBongDa.Url;
using ES.QLBongDa.Web.Authentication.External;
using ES.QLBongDa.Web.Security.Recaptcha;
using ES.QLBongDa.Web.Session;
using ES.QLBongDa.Web.Views.Shared.Components.TenantChange;
using Abp.CachedUniqueKeys;
using Abp.AspNetCore.Mvc.Caching;

namespace ES.QLBongDa.Web.Controllers
{
    public class AccountController : QLBongDaControllerBase
    {
