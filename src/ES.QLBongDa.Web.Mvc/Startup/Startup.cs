...
using ES.QLBongDa.Identity;
using ES.QLBongDa.Schemas;
using ES.QLBongDa.Web.Chat.SignalR;
using ES.QLBongDa.Web.Common;
using ES.QLBongDa.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using ES.QLBongDa.Web.IdentityServer;
using ES.QLBongDa.Web.Swagger;
using Stripe;
...
using ES.QLBongDa.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using ES.QLBongDa.Web.Extensions;
using SecurityStampValidatorCallback = ES.QLBongDa.Identity.SecurityStampValidatorCallback;

namespace ES.QLBongDa.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<QLBongDaWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseQLBongDaForwardedHeaders();
            }
            else
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "QLBongDa API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("ES.QLBongDa.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "QLBongDa API", Version = "v1"});
                ...
                var applicationXml = $"ES.QLBongDa.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"ES.QLBongDa.Web.Core.xml";
