...
using ES.QLBongDa.Web.Areas.App.Models.Languages;
...
namespace ES.QLBongDa.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : QLBongDaControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = QLBongDaConsts.LocalizationSourceName;
            }
