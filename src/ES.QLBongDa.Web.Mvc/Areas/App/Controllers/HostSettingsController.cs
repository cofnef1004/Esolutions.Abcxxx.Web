...
using ES.QLBongDa.Configuration.Host;
using ES.QLBongDa.Editions;
using ES.QLBongDa.Timing;
using ES.QLBongDa.Timing.Dto;
using ES.QLBongDa.Web.Areas.App.Models.HostSettings;
...
namespace ES.QLBongDa.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : QLBongDaControllerBase
    {
