...
{
    [Area("App")]
    [AbpMvcAuthorize(AppPermissions.Pages_QLBongDaUiComponents)]
    public class QLBongDaUiComponentsController : QLBongDaControllerBase
    {
        private readonly IBinaryObjectManager _binaryObjectManager;

        public QLBongDaUiComponentsController(IBinaryObjectManager binaryObjectManager)
        {
        ...
        public async Task<JsonResult> UploadFile(string defaultFileUploadTextInput)
        {
            try
            {
                ...
                var fileObject = new BinaryObject(AbpSession.TenantId, fileBytes, $"QLBongDa ui, uploaded file {DateTime.UtcNow}");
