namespace ES.QLBongDa.Web.Areas.App.Startup
{
    public class AppPageNames
    {
        public static class Common
        {
            ...
            public const string QLBongDaUiComponents = "Administration.QLBongDaUiComponents";
        ...
        {
            public const string ListHLVs = "ListHLVs.ListHLVs";
