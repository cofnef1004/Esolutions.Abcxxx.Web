...
namespace ES.QLBongDa.Web.Areas.App.Views.Shared.Themes.Default.Components.AppDefaultFooter
{
    public class AppDefaultFooterViewComponent : QLBongDaViewComponent
    {
