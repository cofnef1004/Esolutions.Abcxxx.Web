...
using ES.QLBongDa.Web.Public.Startup;
using ES.QLBongDa.Web.Session;

namespace ES.QLBongDa.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : QLBongDaViewComponent
    {
