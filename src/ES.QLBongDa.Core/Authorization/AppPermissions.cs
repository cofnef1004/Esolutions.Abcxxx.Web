namespace ES.QLBongDa.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_HLVs_Delete = "Pages.HLVs.Delete";

        public const string Pages_Nations = "Pages.Nations";
        public const string Pages_Nations_Create = "Pages.Nations.Create";
        public const string Pages_Nations_Edit = "Pages.Nations.Edit";
        public const string Pages_Nations_Delete = "Pages.Nations.Delete";
        ...
        public const string Pages_Vilages_Delete = "Pages.Vilages.Delete";

        public const string Pages_Stadiums = "Pages.Stadiums";
        public const string Pages_Stadiums_Create = "Pages.Stadiums.Create";
        public const string Pages_Stadiums_Edit = "Pages.Stadiums.Edit";
        public const string Pages_Stadiums_Delete = "Pages.Stadiums.Delete";

        public const string Pages_Clubs = "Pages.Clubs";
        public const string Pages_Clubs_Create = "Pages.Clubs.Create";
        ...
        public const string Pages_QLBongDaUiComponents = "Pages.QLBongDaUiComponents";
