...
using ES.QLBongDa.Authorization.Ldap;
...
using ES.QLBongDa.DashboardCustomization.Definitions;
using ES.QLBongDa.Debugging;
using ES.QLBongDa.DynamicEntityProperties;
using ES.QLBongDa.Features;
...
using ES.QLBongDa.Net.Emailing;
using ES.QLBongDa.Notifications;
using ES.QLBongDa.WebHooks;
using Newtonsoft.Json;

namespace ES.QLBongDa
{
    [DependsOn(
        typeof(QLBongDaCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class QLBongDaCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            QLBongDaLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = QLBongDaConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, QLBongDaMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<QLBongDaSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(QLBongDaCoreModule).GetAssembly());
        }
