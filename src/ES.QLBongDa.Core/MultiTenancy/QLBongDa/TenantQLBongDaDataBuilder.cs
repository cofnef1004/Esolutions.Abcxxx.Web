...
namespace ES.QLBongDa.MultiTenancy.QLBongDa
{
    ...
    /// It works only if in DEMO mode ("App.QLBongDaMode" should be "true" in web.config). Otherwise, does nothing.
    /// </summary>
    public class TenantQLBongDaDataBuilder : QLBongDaServiceBase, ITransientDependency
    {
        public bool IsInQLBongDaMode
        {
            get
            {
                return string.Equals(_appConfiguration["App:QLBongDaMode"], "true", StringComparison.OrdinalIgnoreCase);
            }
        }
        ...
        public TenantQLBongDaDataBuilder(
