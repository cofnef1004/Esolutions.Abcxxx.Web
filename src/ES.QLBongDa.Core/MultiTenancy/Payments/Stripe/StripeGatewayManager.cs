...
{
    public class StripeGatewayManager : QLBongDaServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "QLBongDa";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + QLBongDaConsts.Currency;
        }
