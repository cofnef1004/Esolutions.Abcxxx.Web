...
using ES.QLBongDa.Authentication.TwoFactor;
using ES.QLBongDa.Chat;
using ES.QLBongDa.Configuration;
using ES.QLBongDa.EntityFrameworkCore;
using ES.QLBongDa.Startup;
using ES.QLBongDa.Web.Authentication.JwtBearer;
using ES.QLBongDa.Web.Authentication.TwoFactor;
using ES.QLBongDa.Web.Chat.SignalR;
using ES.QLBongDa.Web.Common;
using ES.QLBongDa.Web.Configuration;
using ES.QLBongDa.Web.DashboardCustomization;

namespace ES.QLBongDa.Web
{
    [DependsOn(
        typeof(QLBongDaApplicationModule),
        typeof(QLBongDaEntityFrameworkCoreModule),
    ...
    public class QLBongDaWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public QLBongDaWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(QLBongDaApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(QLBongDaWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(QLBongDaWebCoreModule).Assembly);
        }
