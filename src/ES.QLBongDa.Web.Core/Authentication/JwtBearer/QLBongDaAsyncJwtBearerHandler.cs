...
{
    public class QLBongDaAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public QLBongDaAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
