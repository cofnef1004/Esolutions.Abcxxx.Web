...
/// </summary>
public static class QLBongDaJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, QLBongDaAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
