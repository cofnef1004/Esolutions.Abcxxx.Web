...
$webMvcFolder = Join-Path $slnFolder "src/ES.QLBongDa.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/ES.QLBongDa.Web.Public"
...
dotnet restore ES.QLBongDa.Web.sln
